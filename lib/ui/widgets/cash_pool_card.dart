...
class CashPoolCard extends StatelessWidget {
  final int amount;
      ...
      child: ClipRRect(
        ...
        child: IntrinsicHeight(
          child: Row(
            ...
            children: [
              // Left accent bar
              Container(width: 4, color: Colors.purple),
              // Icon
              Padding(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.account_balance_wallet_rounded, color: Colors.purple, size: 20),
                ),
              ),
              // Content
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      Row(children: [
                        Icon(Icons.account_balance_wallet_outlined, size: 11, color: context.colorTextTertiary),
                        SizedBox(width: 3),
                        Text('Cash Pool', style: GoogleFonts.inter(fontSize: 11, color: context.colorTextTertiary)),
                      ]),
                    ],
                  ),
                ),
